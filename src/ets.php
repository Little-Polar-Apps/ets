 ...
 * This file serves as the default master copy of ETS, with the
 * repoistory acting as a location for plugins and usage examples
 * for other projects.
 * It is not expected for this file to change much.
 * If you spot anything that needs improvements please, fork and pull
 * request.
 *
